...
setver buildifier '$(v=(`buildifier -version | head -1`); echo ${v[-1]%%-*})'
setver buildozer '$(v=(`buildozer -version | head -1`); echo ${v[-1]%%-*})'
...
setver make '$(v=(`make --version | head -1`); echo ${v[-1]})'
...
setver rsync '$(v=(`rsync --version | head -1`); echo ${v[2]})'
