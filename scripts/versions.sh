...
setver ansible '$(v=(`ansible --version`); echo ${v[2]%\]})'
...
setver gcc '$(v=(`gcc --version`); echo ${v[2]})'
...
setver gzip '$(v=(`gzip --version`); echo ${v[1]})'
...
setver helm-secrets '$(helm secrets --version)'
...
setver kubectl '$(v=(`kubectl version --client`); echo ${v[2]#v})'
...
setver make '$(v=(`make --version`); echo ${v[2]})'
...
setver ripgrep '$(v=(`rg --version`); echo ${v[1]})'
setver rsync '$(v=(`rsync --version`); echo ${v[2]})'
setver runc '$(v=(`runc --version`); echo ${v[2]})'
setver skopeo '$(v=(`skopeo --version`); echo ${v[2]})'
setver sops '$(v=(`sops --version`); echo ${v[1]})'
setver sshpass '$(v=(`sshpass -V`); echo ${v[1]})'
setver tar '$(v=(`tar --version | head -1`); echo ${v[-1]})'
setver terraform '$(v=(`terraform version`); echo ${v[1]#v})'
...
setver wget '$(v=(`wget --version`); echo ${v[2]})'
setver which '$(v=(`which --version`); v=${v[2]#v}; echo ${v%,})'
